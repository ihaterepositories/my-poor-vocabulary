...
namespace Modules.SchoolSystem.AccountRegistration.Requests
{
    public class RegistrationRequestHandler
    {
        public IEnumerator SendRegisterRequest(AccountType accountType, string jsonBody, Action<NoReturnDataResponse> onResult)
        {
        ...
        private string BuildUrl(AccountType accountType)
        {
